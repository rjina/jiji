...
public class BoardController {
	...
	private void deleteFiles(List<BoardAttachVO> attachList) {
		...
		attachList.forEach(attach -> {
			try {
				Path file = Paths.get("C:\\project\\upload\\"+attach.getUploadPath()+"\\"+attach.getUuid()+"_"+attach.getFileName());
				
				Files.deleteIfExists(file);
				
				if(Files.probeContentType(file).startsWith("image")) {
					Path thumbNail = Paths.get("C:\\project\\upload\\"+attach.getUploadPath()+"\\s_"+attach.getUuid()+"_"+attach.getFileName());
